function [z, a, b, alpha,errctr] = fitellipse(x, varargin)
...
switch params.constraint
    ...
    case 'bookstein'
        [z, a, b, alpha,errctr] = fitbookstein(x);
...
function [z, a, b, alpha,errctr] = fitbookstein(x)
...
% Find the parameters
[z, a, b, alpha,errctr] = conic2parametric(A, bv, c);
...
function [z, a, b, alpha,errctr] = conic2parametric(A, bv, c)
